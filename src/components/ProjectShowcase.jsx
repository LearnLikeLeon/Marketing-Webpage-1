...
{
  /* We will import the data from a ' static files ' folder :
        1- A static external projects or posts file .
        2- From the database using its endpoint.
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <section className="border-t border-gray-200">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3 mt-8">
            {posts_classified_2.slice(0, 3).map((post) => (
